...
class mod_xiroweb_tinnhatInstallerScript
{
...
<div class="template-intro">
			<div class="intro-header">
				<div class="template-intro-container gradient-light-blue">
					<div class="row-fluid">
					<div class="span12">
						<h1 class="intro-header-title">
							<?php echo Text::_('MOD_XIROWEB_TINNHAT'); ?>
						</h1>
						</div>
					</div>
			...
			<div class="intro-content">
				<section class="intro-content-highlights">
					<div class="template-intro-container">
						<div class="row-fluid">
							<?php echo Text::_('MOD_XIROWEB_TINNHAT_XML_DESCRIPTION_INSTALL'); ?>
						</div>
						<div class="row-fluid">
							<div class="span12">
			...
			<div class="intro-footer">
				...
				<ul class="version-history">
					<li class="text-center"><?php echo Text::_('MOD_XIROWEB_MULTI_CUSTOM_INSTALL_DESC3'); ?></li>
				</ul>
				<div class="template-intro-container">
					<a class="btn btn-success btn-large" target="_blank" href="https://www.xiroweb.com/app/xiroweb-module-tin-nhat"><?php echo Text::_('MOD_XIROWEB_TINNHAT'); ?></a>
				</div>
			</div>
		</div>
		<?php
